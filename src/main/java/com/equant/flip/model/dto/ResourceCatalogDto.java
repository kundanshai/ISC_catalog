package com.equant.flip.model.dto;
...
public class ResourceCatalogDto implements Serializable{
	...
	List<ResourceProductRevision> resourceProductRevisionList;
	...
	public String getxGsaFlex2() {
		return xGsaFlex2;
	}
	public void setxGsaFlex2(String xGsaFlex2) {
		this.xGsaFlex2 = xGsaFlex2;
	}
